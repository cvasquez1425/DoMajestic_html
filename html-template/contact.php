...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    <meta charset="utf-8">
    <title>Hairpress, HTML template - Contact Us</title>
    		...
    		<div class="row">
    			<div class="span3">
				    ...
				    <div class="left sidebar">
		                ...
		                <div class="sidebar-item">
		                	...
		                	<strong class="black-clr">ProteusNet d.o.o.</strong> <br />
							Prežihova ulica 17<br />
							8250 Brežice <br />
							Slovenia<br /><br />
							...
							Web: <strong class="black-clr">www.proteusthemes.com</strong>
    			...
    			<div class="span9">
    				...
    				<article class="inner-content">
    					...
    					<div class="lined">
    						<h2><span class="light">SEND</span> US AN EMAIL</h2>
    ...
    <footer>
        ...
        <div class="container">
        	<div class="row">
        		...
        		<div class="span6">
        		    <div class="pull-right">Hairpress Theme by <a href="http://www.proteusthemes.com">ProteusNet</a></div>
    		    </div>
        	</div>
        </div>
    </footer>
